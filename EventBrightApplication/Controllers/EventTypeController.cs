...
namespace EventBrightApplication.Controllers
{
    public class EventTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TypeId,TypeName,TypeDescription")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TypeId,TypeName,TypeDescription")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
